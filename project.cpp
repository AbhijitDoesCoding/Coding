...
public:
    Judge(const string& personName = "", const string& personEmail = "") 
        : Person(personName, personEmail) {}
};
...
public:
    ...
    // New methods to get counts and retrieve participants and teams
...
void displayMenu() {
    ...
    cout << "2. Add Judge\n";
    cout << "3. Create Team\n";
    cout << "4. Edit Team\n"; // Added option to edit team
    cout << "5. Display Hackathon Details\n";
    cout << "6. Exit\n";
    cout << "Choose an option: ";
}
    ...
    do {
        ...
        switch (choice) {
            ...
            case 2: { // Add Judge
                ...
                getline(cin, email);
                hackathon.addJudge(Judge(name, email));
            ...
            case 3: { // Create Team
                ...
                hackathon.addTeam(Team(teamName));
            ...
            case 5: // Display Hackathon Details
